...
_Last Updated:_ 2026-06-04 11:43:00
...
- **Google Antigravity SDK CLI**: A standalone interactive loop utility `scripts/interactive_loop.py` is implemented for running and testing agents on WSL/Linux/macOS using the `google-antigravity` framework.
