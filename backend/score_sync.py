...
"""
Utilities for extracting completed game scores from datasets and schedules.

The prediction history store uses SQLite as the source of truth for resolved
games. These helpers normalize score rows from different pipeline surfaces into
one canonical home-team/away-team keyed shape.
"""
